...
public class Result<T> implements Serializable {
    ...
    @Serial
    private static final long serialVersionUID = -6832599539653600493L;
     ...
     * @return result
     */
    public static <T> Result<T> ofFail(BasicException e) {
        return new Result<>(e.getStatus(), e.getCode(), e.getClientMessage(), e.getServerMessage(), null, e.getDataMap());
    }
