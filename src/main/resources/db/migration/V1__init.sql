...
(
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'im会话表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'im用户会话表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户好友表'
  ROW_FORMAT = Dynamic;
...
VALUES (1, 1, '1', '2026-04-08 11:54:54', '2026-04-08 11:54:54');
...
(
    ...
    `status`      tinyint(255)                                                  NOT NULL DEFAULT 0 COMMENT '用户状态（0-离线，1-在线，2-忙碌，3-隐身），默认0',
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'im账户表'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `im_user`
VALUES (1, '2', '1', NULL, NULL, 1, 1, 0, '2026-03-31 16:01:29', '2026-04-09 20:58:22');
